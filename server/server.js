...
// console.log("printing static public address in:::", path.join(__dirname, "public"));
...
const port = process.env.PORT || 3000; //edit to reflect slide 20 of deployment lecture
